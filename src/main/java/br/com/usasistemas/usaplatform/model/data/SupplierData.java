...
public class SupplierData  implements Serializable {
	...
	public Double getQualityRate() {
		if (qualityRate == null) return 0.0D;
		return qualityRate;
	}
	...
	public Long getQualityCount() {
		if (qualityCount == null) return 0L;
		return qualityCount;
	}
	...
	public Double getDeliveryRate() {
		if (deliveryRate == null) return 0.0D;
		return deliveryRate;
	}
	...
	public Long getDeliveryCount() {
		if (deliveryCount == null) return 0L;
	...
	public Double getPaymentConditionRate() {
		if (paymentConditionRate == null) return 0.0D;
	...
	public Long getPaymentConditionCount() {
		if (paymentConditionCount == null) return 0L;
