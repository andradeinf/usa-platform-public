		...
		<div class="navbar-header">
			...
			<div class="logo-wrapper">
				<a class="navbar-brand" href="#">
					<img class="img-responsive navbar-logo" src="/img/usafood_logo.png" />
				</a>
			</div>
		</div>
			...
			<div class="col-md-7">
				<div class="content center-block">
					<p class="text-center">Somos uma solução completa para integrar, registrar e agilizar a compra de insumos 
					 entre estabelecimentos e indústrias que atuam no segmento da gastronomia.</br>
					 </br>
					 Com objetivo de reduzir custos, gerando volume com a compra coletiva, a ferramenta
					  se torna uma união entre os estabelecimentos gastronômicos.</p>
			...
			<div class="col-xs-12">
				<div class="row contact-row">
					<div class="col-md-6 text-center">
						<button type="button" class="btn btn-default contact-button" ng-click="toggleFranchiseeContact()">Quero Comprar pelo Usa | Food</button>
					</div>
					<div class="col-md-6 text-center">
						<button type="button" class="btn btn-default contact-button" ng-click="toggleSupplierContact()">Quero Vender pelo Usa | Food</button>
					</div>
				</div>
					...
					<div class="col-md-8">
						<div class="form-wrapper center-block contact-details">
							...
							<div class="row">
								...
								<div class="col-xs-9"><p><a href="mailto:contato@usafood.com.br">contato@usafood.com.br</a></p></div>
							</div>
							<div class="row">
	...
	<div class="container-fluid">
		<div class="row login-page">
			<div class="col-md-4 col-md-offset-4">
				<div class="row">
                	<img class="login-form-img" src="/img/usafood_logo_login.png" />
                </div>
	...
	<div class="container-fluid">
		<div class="row contact-page">
			<div class="col-md-8 col-md-offset-2">
				<div class="row">
                	<img class="contact-page-img" src="/img/usafood_logo_login.png" />
                </div>
				<form class="contact-form form-horizontal">
		            ...
		            <div class="contact-form-footer">            
						<div class="row">
		                	<small>Envie-nos os dados acima para se tornar um estabelecimento cadastrado e comprar através do Usa | Food</small>
		                </div>
		            </div>
		        </form> 
			</div>
		...
		<div class="row contact-page">
			<div class="col-md-8 col-md-offset-2">
				...
				<form class="contact-form form-horizontal">
		            ...
		            <div class="contact-form-footer">            
						<div class="row">
		                	<small>Envie-nos os dados acima para se tornar um fornecedor cadastrado e vender através do Usa | Food</small>
		                </div>
		            </div>
		        </form> 
			</div>
