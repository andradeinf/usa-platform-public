	        ...
	        <div class="modal-body">
				<form role="form">
					...
					<div class="form-group" id="supplier">
						...
						<select id="inputSupplier" class="form-control" ng-model="deliverieRequestsByTimeRangeReport.filterSupplierId" ng-options="unit.id as unit.name for unit in suppliers | orderBy:'name'"></select>     
					</div>
					<div class="form-group" id="franchisee">
						...
						<select id="inputFranchisee" class="form-control" ng-model="deliverieRequestsByTimeRangeReport.filterFranchiseeId" ng-options="unit.id as unit.name for unit in franchisees | orderBy:'name'"></select>     
					</div> 					
		    	</form>
	        </div>
...
<div class="panel panel-default">
	...
	<div class="panel-body">
		<table class="table table-striped table-bordered history-table">
            ...
            <tbody>
                <tr ng-repeat="item in deliverieRequestsByTimeRangeReports | orderBy:'date':true">
