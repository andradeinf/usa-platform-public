...
<div class="page-header">
	<h3 class="panel-title"><i class="fa fa-money"></i> Contas a Pagar</h3>
</div>
	...
	<div class="panel-body">
		<div class="panel panel-list">
			...
			<div class="panel-body">			
	        	...
	        	<p ng-show="noRecordsFound" class="text-info text-center">Não há entregas a pagar para este filtro!</p>
			</div>
		</div>
    </div>
    <!-- Loading -->
