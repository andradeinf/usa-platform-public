	        ...
	        <div class="modal-body">
				<form role="form">
  						...
  						<div class="row">
  							<div class="col-sm-5">
  								<div class="input-group">
		  							...
		  							<input id="inputInitDate" type="text" class="form-control" uib-datepicker-popup="dd/MM/yyyy" ng-model="supplierDeliveriesByTimeRangeReport.initDate" is-open="filter.fromDateOpened" datepicker-options="dateOptions" show-button-bar="False" alt-input-formats="altInputFormats" on-open-focus="False" data-inputmask='"mask": "d/m/y", "showTooltip": "true"' input-mask-initialize />
					...
					<div class="form-group" id="franchisor">
		                ...
		                <select id="inputFranchisor" class="form-control" ng-model="supplierDeliveriesByTimeRangeReport.filterFranchisorId" ng-options="unit.id as unit.name for unit in franchisors | orderBy:'name'"></select>     
		            </div>
		    	</form>
	        </div>
...
<div class="panel panel-default">
	...
	<div class="panel-body">
		<table class="table table-striped table-bordered history-table">
            ...
            <tbody>
                <tr ng-repeat="item in supplierDeliveriesByTimeRangeReports | orderBy:'date':true">
