				                            ...
				                            <ul class="list-unstyled">
				                            	...
				                            	<li ng-show="item.showFullContactInfo">
				                                	<ul class="list-unstyled margin-left-25">
				                                    	<li><i class="fa fa-angle-right"></i> <strong>Razão Social:</strong> {{item.franchisee.corporateName}}</li>
				                                    	<li><i class="fa fa-angle-right"></i> <strong>CNPJ:</strong> {{item.franchisee.fiscalId}}</li>
				                                    	<li><i class="fa fa-angle-right"></i> <strong>Contato:</strong> {{item.franchisee.contactName}}</li>
				                                    	<li><i class="fa fa-angle-right"></i> <strong>Telefone:</strong> {{item.franchisee.contactPhone}}</li>
				                                    	<li><i class="fa fa-angle-right"></i> <strong>E-mail:</strong> {{item.franchisee.contactEmail}}</li>
				                                    	<li><i class="fa fa-angle-right"></i> <strong>Endereço:</strong> {{item.franchisee.address}}</li>
				                                    	<li><i class="fa fa-angle-right"></i> <strong>Informações Adicionais:</strong> <span ta-bind="text" ng-model="item.franchisee.additionalInformation"></span></li>
				                                	</ul>
				                                </li>
				                            ...
				                            <div ng-show="item.updateStatusRequestMode" class="list-group-item-actions">
				                            	<form>
				                            		<div class="form-group">
							  						...
							  						<div class="form-group" ng-show="item.updateStatusRequest.status == 'COMPLETED'">
							    						<label for="dueDate">Data de Vencimento da Nota Fiscal:</label>
									...
									<div class="row list-group-item-row">
										...
										<div class="col-sm-7 list-group-item-column clearfix">
				                            ...
				                            <ul class="list-unstyled">
				                            	...
				                            	<li ng-show="item.showFullContactInfo">
				                                	<ul class="list-unstyled margin-left-25">
				                                    	<li><i class="fa fa-angle-right"></i> <strong>Razão Social:</strong> {{item.franchisor.corporateName}}</li>
				                                    	<li><i class="fa fa-angle-right"></i> <strong>CNPJ:</strong> {{item.franchisor.fiscalId}}</li>
				                                    	<li><i class="fa fa-angle-right"></i> <strong>Contato:</strong> {{item.franchisor.contactName}}</li>
				                                    	<li><i class="fa fa-angle-right"></i> <strong>E-mail:</strong> {{item.franchisor.contactEmail}}</li>
				                                    	<li><i class="fa fa-angle-right"></i> <strong>Telefone:</strong> {{item.franchisor.contactPhone}}</li>
				                                    	<li><i class="fa fa-angle-right"></i> <strong>Endereço:</strong> {{item.franchisor.address}}</li>
				                                    	<li><i class="fa fa-angle-right"></i> <strong>Informações Adicionais:</strong> <span ta-bind="text" ng-model="item.franchisor.additionalInformation"></span></li>
				                                	</ul>
				                                </li>
				                            	<li ng-show="item.product.sizes.length > 1"><i class="fa fa-check"></i> <strong>{{item.product.sizeName}}:</strong> {{item.productSize.name}} <spam ng-show="item.productSize.description != null && item.productSize.description != ''"> - {{item.productSize.description}}</spam></li>
